        ...
        <form action="InscriptionAuteur" method="post" id="frmNewCompte">
            <div class="input-group mb-3">
                        <span class="input-group-text"><img
                                ...
                                width="25"></span>
                <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom" value="${infoSaisi.nom}"
                       required>
                &nbsp;&nbsp;
                <span class="input-group-text"><img
                        src="${pageContext.request.contextPath}/resources/images/icones/icons8-info.png"
                ...
                <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Prénom"
                       value="${infoSaisi.prenom}" required>
            </div>
            <p class="line1"></p>
            <div class="input-group mb-3">
                        <span class="input-group-text"><img
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="code" name="code"
                       placeholder="Votre code" value="${code}" required>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="login" name="login" placeholder="Login"
                       value="${infoSaisi.login}" required>
                &nbsp;&nbsp;

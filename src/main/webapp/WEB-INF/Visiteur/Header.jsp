...
<%--                                <input type="password" class="form-control" type="search" placeholder="Recherche..." required>--%>
<%--                                <span class="input-group-text" id="basic-addon2"> <img src="${pageContext.request.contextPath}/resources/images/icones/icons8-found-24.png" width="25" ></span>--%>
